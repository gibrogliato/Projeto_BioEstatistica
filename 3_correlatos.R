# Descrição do Script:
# Esse script calcula a correlação de conjunto selecionado de variáveis (Age, Gender, BMI, etc.) e a variável Diagnosis.
...
prop <- prop.table(table(dados_alzheimer$CardiovascularDisease))
barplot(prop,
...
#--------------------------------
# Correlação de  dados clínicos dos pacientes
